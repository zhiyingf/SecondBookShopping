...
h1 {
  ...
  function a(){
	  ...
	  var textnode=document.createTextNode("图书管理 > 我的书单 > 更新书单");
...
%>
  ...
  <div class="bodyall">
    ...
    <div class="contentsheet01">
        ...
        <%--主体部分  表单 --%>
        <P>输入需更新的书单信息，带*号项必须填写：</P>
        <strong>${message}</strong>
		<FORM action="UpdateBookListServlet" Method="post">
		<%--<div class="row">订阅号<input type=text name="order_number" class="txt" value="${mybook.order_number}" disabled="disabled">*</div> --%>
		<div class="row">书&nbsp;&nbsp;&nbsp;&nbsp;名<input type=text name="bookname" class="txt" value="${mybook.bookname}">*</div>
		<div class="row">作&nbsp;&nbsp;&nbsp;&nbsp;者<input type=text name="author" class="txt" value="${mybook.author}">*</div>
		<div class="row">出版社<input type=text name="publisher" class="txt" value="${mybook.author}">*</div>
		<div class="row">数&nbsp;&nbsp;&nbsp;&nbsp;量<input type=text name="booknumber" class="txt" value="${mybook.booknumber}">*</div>
		<div class="row">单&nbsp;&nbsp;&nbsp;&nbsp;价<input type=text name="price" class="txt" value="${mybook.price}">*</div>
		<div class="row">图&nbsp;&nbsp;&nbsp;&nbsp;片<input type=text name="bookImg" class="txt" value="${mybook.bookImg}">*</div>
		<%--<div class="row">发布人<input type=text name="logname" value="${mybook.logname }" class="txt">*</div> --%>
